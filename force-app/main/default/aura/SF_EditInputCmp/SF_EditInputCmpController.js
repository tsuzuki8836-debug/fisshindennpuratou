({
	...
	handleInputNumber: function(component, event, helper){
		...
		var input = component.find("myStandardInput");
		var valueChanged = input.get("v.value");
		var currentScale = component.get("v.scale");
		var decimalLength = Math.log10(1/currentScale);
	...
	onChange : function(component, event, helper) {
		...
		if (typeof(event.currentTarget.type) !== 'undefined'){
			var valueChanged = event.currentTarget.value;
	...
	onCommitNumber: function(component, event, helper){
		var valueChanged = component.find("myStandardInput").get("v.value");
